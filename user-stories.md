...
| 2.6  | Provide GUI-elements for attaching sound from own library                                 | Must | 2      |
| 2.7  | Provide GUI-elements for picking sound from shared-repository                             | Must | 3      |
| 2.8  | Provide GUI-elements for attaching 2D-image from own library                              | Must | 2      |
| 2.9  | Provide GUI-elements for attaching 2D-image from shared-repository                        | Must | 3      |
| 2.10 | Provide GUI-elements for attaching 3D-model from shared-repository                        | Must | 3      |
| 2.11 | Create button to submit new SOS (containing sound, visual representation & location)      | Must | 1      |
| 2.13 | Once tapped make authenticated request to the SOS-creation server-endpoint                | Must | 2      |
